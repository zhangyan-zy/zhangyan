...
public class StatisticalSericeImpl extends ServiceImpl<StatisticalDao, CoustomerCountEntity> implements StatisticalService {

    @Override
    public List<CoustomerCountEntity> selectCoustomerList(Map<String, Object> params) {
        ...
        IPage<CoustomerCountEntity> pages = new Page<>(page, limit);
        List pagess=  baseMapper.selectCoustomerList(parentId, date1, date2, pages);
        return pagess;
    }
